...
# End Turn button — right side, vertically centered on the divider line so
# the cyan separator runs straight through the middle of the button.
END_TURN_BUTTON_RECT = (SCREEN_WIDTH - 195, DIVIDER_Y - 25, 180, 50)
